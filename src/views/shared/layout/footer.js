    ...
    <section className="overflow-hidden relative gap-5 px-[50px] md:px-16 lg:px-24 lg:border-none border-t border-[#FFFFFF] ">
      ...
      <div className="flex lg:flex-row flex-col lg:items-start items-center 2xl:gap-[100px] xl:gap-[80px] gap-[50px] md:pt-[56px] pt-[25px] md:pb-[76px] pb-10 lg:border-t border-[#FFFFFF] w-full">
          ...
          {["Home", "How It Works", "Our Games", "Work With Us"].map(
            (text, index) => (
              <a
                ...
                className="hover:underline xl:text-big-title text-[40px] xl:leading-[74.1px] leading-[50px] font-medium tracking-[-1%] text-[#ffffff] lg:text-start text-center"
              >
                {text}
              </a>
            )
        ...
        <div className="w-full flex flex-col space-y-2 lg:items-start items-center">
          ...
          <a
            ...
            className="xl:text-default-title text-paragraph xl:leading-[59.28px] md:leading-[40.28px] leading-[30.28px] font-medium tracking-[-1%] text-[#ffffff] md:mb-[30px]"
          >
      ...
      <div className="flex lg:flex-row flex-col lg:items-start items-center 2xl:gap-[100px] xl:gap-[80px] gap-[50px] md:pt-[56px] pt-[25px] md:pb-[76px] pb-10 lg:border-t border-[#FFFFFF] w-full">
        ...
        <div className="w-full lg:text-start text-center">
          <a
            href="#terms"
            className="text-caption text-[16px] leading-[24.2px] font-normal tracking-[-1%] text-[#ffffff]"
          >
