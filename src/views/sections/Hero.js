...
const Hero = () => {
  return (
    <section className="w-full min-h-[963px] xxl-max-screen mx-auto flex flex-col  justify-end pb-[69px] xl:px-[100px] lg:px-[50px] md:px-16 px-4 pr-[65px] relative">
        ...
        <div className="">
          ...
          <div className="flex items-end">
            <div className="w-[612px]">
              ...
              <div className="flex lg:items-center items-end lg:justify-center justify-start gap-3 gap-[10px]">
            ...
            <h1 className="lg:flex hidden flex-shrink-0 font-bold stroke-custom 2xl:text-hero-large lg:text-[150px] md:text-[110px] text-[90px] leading-[166px] bg-main-gradient bg-clip-text text-fill-transparent md:tracking-[-1.8px] tracking-[-0.9px] uppercase relative z-10">
              Win Big
            </h1>
          </div>
        </div>
