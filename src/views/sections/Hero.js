      ...
      <div className="w-full flex items-end justify-between relative z-20">
        <div className="">
          ...
          <div className="flex items-end">
            ...
            <h1 className="lg:flex hidden flex-shrink-0 font-bold  2xl:text-hero-large lg:text-[150px] md:text-[110px] text-[90px] leading-[138px] hero-free-win-big-text md:tracking-[-1.8px] tracking-[-0.9px] uppercase relative z-10">
              Win Big
            </h1>
          </div>
        </div>
