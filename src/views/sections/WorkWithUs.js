...
const WorkWithUsSection = () => {
  return (
    <section className='xxl-max-screen work-with-us-box flex bg-transparent md:bg-inherit flex-col-reverse md:flex-row gap-[30px] items-center justify-between pt-[168px] pb-16 xl:px-[100px] lg:px-[50px] md:px-16 relative'>
      ...
      {/* Image Section */}
      <div className='w-full md:mt-10 md:w-1/2 flex justify-center relative'>
        ...
        <div className=' md:hidden block absolute  bottom-0 right-0 h-full w-full'>
          <img
            src='/images/work-border-mobile.svg'
            alt=''
