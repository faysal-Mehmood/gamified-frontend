...
const StartEarning = () => {
  return (
    <section className='relative xxl-max-screen xl:pl-[100px] lg:pl-[50px] md:pl-16 pt-28 relative'>
      ...
      <div
        className='absolute w-max h-max  bottom-[ -85%]
    right-[-56%]'>
        <img src='/images/green-shadow.svg' alt='auto' className='' />
      </div>
    </section>
  );
};
